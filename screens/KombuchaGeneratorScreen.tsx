    ...
    <PageLayout title="Générateur de Recette de Kombucha" showBackButton>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-100 calculator:text-calc-text-muted">{KOMBUCHA_PROFILE_HELP}</p>
        </div>
        <div>
          <Select
          ...
          />
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-100 calculator:text-calc-text-muted">{KOMBUCHA_TEA_HELP}</p>
        </div>

        <div className="rounded-lg calculator:rounded-none border border-gray-200 dark:border-gray-700 dark:border-gray-700 calculator:border-calc-border bg-gray-50/50 dark:bg-gray-900/50 dark:bg-gray-900 calculator:bg-calc-bg p-4">
          <strong className="block mb-1 text-gray-900 dark:text-gray-100 dark:text-gray-100 calculator:text-calc-text">Profil de goût attendu</strong>
          <p className="text-gray-700 dark:text-gray-400 dark:text-gray-400 dark:text-gray-100 calculator:text-calc-text-muted text-sm">
      ...
      {result && !result.error && (
        <div className="mt-8 space-y-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 calculator:text-calc-text">{result.title}</h2>

          <div>
            <strong className="block mb-1 text-gray-900 dark:text-gray-100 dark:text-gray-100 calculator:text-calc-text">Profil de goût attendu</strong>
            <p className="text-gray-700 dark:text-gray-400 dark:text-gray-400 dark:text-gray-100 calculator:text-calc-text-muted">
          ...
          <div>
            ...
            <ul className="list-none space-y-2">
              {result.ingredients.map((ing, index) => (
                <li key={index} className="p-3 rounded-lg calculator:rounded-none bg-gray-50 dark:bg-gray-800 dark:bg-gray-900 calculator:bg-calc-bg flex justify-between items-center shadow-sm dark:shadow-none calculator:shadow-none calculator:border dark:border-gray-700 calculator:border-calc-border">
                  <span className="text-gray-900 dark:text-gray-100 dark:text-gray-100 calculator:text-calc-text">{ing.name}</span>
                  <span className="font-semibold text-[#2563FF] dark:text-gray-100 dark:text-gray-100 calculator:text-calc-text">
                    {ing.amount} {ing.unit}
                  </span>
                </li>
              ))}
          ...
          <div>
            ...
            <ol className="list-decimal list-outside space-y-3 pl-5">
              {result.instructions.map((step) => (
                <li key={step.step} className="text-gray-700 dark:text-gray-400 dark:text-gray-400 dark:text-gray-100 calculator:text-calc-text-muted leading-relaxed">
                  {step.text}
                </li>
              ))}
            </ol>
            <div className="mt-3 space-y-3 text-sm text-amber-800 dark:text-gray-100 dark:text-gray-100 calculator:text-calc-text rounded-lg calculator:rounded-none bg-amber-50 dark:bg-gray-800 dark:bg-gray-900 dark:bg-gray-800 calculator:bg-calc-bg-card p-4 border border-amber-200 dark:border-gray-700 dark:border-gray-700 calculator:border-calc-border">
              ...
              <p className="text-amber-900 dark:text-gray-100 font-medium">En cas de doute, ne pas consommer.</p>
