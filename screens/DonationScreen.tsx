    ...
    <PageLayout title="Offrir une bière 🍻" showBackButton>
      <div className="space-y-6">
        <div className="space-y-3 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            <a
              ...
              className="text-[#2563FF] dark:text-[#6b99ff] hover:underline"
            >
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Montant</h2>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {PRESET_AMOUNTS.map((amount) => (
              <button
                ...
                className="flex items-center justify-center py-4 px-4 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 hover:border-[#2563FF] dark:hover:border-[#6b99ff] hover:shadow-md transition-all duration-200 font-semibold text-gray-900 dark:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {amount} €
              </button>
            ))}
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Autre montant</h2>
